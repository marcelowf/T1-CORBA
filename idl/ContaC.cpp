...
void
TAO::Objref_Traits<Conta>::release (Conta_ptr p)
{
  ::CORBA::release (p);
}
...
void
Conta::_tao_any_destructor (void *_tao_void_pointer)
{
...
void
Conta::_tao_release (Conta_ptr obj)
{
  ::CORBA::release (obj);
}
